...
p9 <- medidas(db_original_REF$N.PS, 'PS') + guides(color='none')+theme(axis.title.y = element_blank())
...
p9_n <- medidas_nor(db_Normalized$N.PS, 'PS')+theme(axis.title.y = element_blank())
